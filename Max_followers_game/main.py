#importing the required datad from other module's
...
def game():
    ...
    while should_continue:
        ...
        #What if the random choice is same as first chocie
...
#call game function to stgart playing game
game()